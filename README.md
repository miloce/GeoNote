# NULL-杜正阳-迹记
##### 鸿蒙应用核心代码./entry/src/main/
##### 鸿蒙应用测试下载链接：https://appgallery.huawei.com/link/invite-test-wap?taskId=358b29ee9c22b7a751059a98b028df7b&invitationCode=KCfZBMgau9
###### 测试账号：demo
###### 测试密码：123456
## **一、基础信息**
### **1.1 作品概述**
...
|开发平台|DevEco Studio 6.0.0|集成开发环境，支持代码编写、调试、模拟器、真机部署|
|运行平台|HarmonyOS NEXT 5.0.0及以上|设备运行环境与系统能力|
|地图服务|高德地图 SDK（amap\_lbs\_map3d、amap\_lbs\_location）|地图展示、定位服务、逆地理编码|
